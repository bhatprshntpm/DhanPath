      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-xs text-surface-300 font-medium">/ 100</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold" style={{ color: hs.color }}>{hs.grade}</span>
          </div>
          <p className="text-sm font-semibold text-surface-800">{label.text}</p>
          <p className="text-xs text-surface-300 max-w-[200px]">{label.sub}</p>
        </div>
      </div>
